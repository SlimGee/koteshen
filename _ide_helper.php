...
namespace Butschster\Head\Facades {
     ...
     */        class Meta {
         ...
         */        public static function flushMacros()
        {
                        \Butschster\Head\MetaTags\Meta::flushMacros();
        }
                    /**
         * 
         *
         ...
         *
         * @static 
         */        public static function replacePackage($package)
        {
                        /** @var \Butschster\Head\MetaTags\Meta $instance */
                        return $instance->replacePackage($package);
        }
                    /**
         * 
         *
        ...
        {
                        /** @var \Butschster\Head\MetaTags\Meta $instance */
                        return $instance->removePackage($name);
        }
                    /**
         * 
         *
...
namespace FlixtechsLabs\LaravelAuthorizer\Facades {
     ...
     */        class Authorizer {
         ...
         *
         * @static 
         */        public static function getPermissionsFor($model)
        {
                        /** @var \FlixtechsLabs\LaravelAuthorizer\LaravelAuthorizer $instance */
                        return $instance->getPermissionsFor($model);
        }
                    /**
         * Get all models.
         *
...
namespace HotwiredLaravel\StimulusLaravel\Facades {
     ...
     */        class StimulusLaravel {
        ...
        {
                        /** @var \HotwiredLaravel\StimulusLaravel\StimulusLaravel $instance */
                        return $instance->controller($controllers);
        }
                    /**
         * 
         *
         * @static 
         */        public static function target($targets)
        {
                        /** @var \HotwiredLaravel\StimulusLaravel\StimulusLaravel $instance */
                        return $instance->target($targets);
        }
            }
    }
