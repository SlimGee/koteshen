...
class HomeController extends Controller
{
    public function index(): Renderable
    {
        Meta::prependTitle('Invoicing Stress & Wasted Time? Get Koteshen & Get Back to Business')
            ->setDescription('itch clunky spreadsheets and invoicing dread. Koteshen automates your billing, so you get paid faster, reduce errors, and gain the financial clarity you need.')
