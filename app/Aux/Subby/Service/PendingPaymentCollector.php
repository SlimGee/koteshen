...
namespace App\Aux\Subby\Service;
...
class PendingPaymentCollector
{
    ...
    public function collectAllPayments()
    {
        ...
        return $scheduled
            ->whenEmpty(function ($collection) use ($regularDiff) {
                return $regularDiff;
            })
            ->whenNotEmpty(function ($collection) use ($regularDiff) {
                return $collection->merge($regularDiff);
            })
