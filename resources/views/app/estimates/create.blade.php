    ...
    <section
        ...
        <form action="{{ route('app.estimates.store') }}" method="post">
            ...
            <div class="p-4 py-10 w-full rounded border md:w-6/12">
                <div class="mb-10">
                    <h1 class="text-lg font-semibold md:text-2xl text-slate-700">Estmate</h1>
                </div>
                        ...
                        <div class="flex flex-col mb-3 space-y-3 md:flex-row md:space-y-0 md:space-x-3">
                            ...
                            <div class="w-full md:w-1/2">
                                ...
                                <x-form.select class="mt-1 w-full" id="expires_in" name="expires_in"
                                    data-controller="choices" data-action="invoice#selectDueDate"
                                    data-invoice-target="customDateSelect"
