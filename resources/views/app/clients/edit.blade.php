...
@section('content')
    <section>
        <div class="flex justify-between items-center md:items-baseline">
            <div class="flex items-center space-x-1">
                ...
                <h1 class="text-xl font-semibold md:text-2xl text-slate-700">Update client information</h1>
            </div>
        </div>
    </section>
    ...
    <section class="py-16">
        ...
        <div class="md:w-1/2"
            ...
            <form action="{{ route('app.clients.update', $client) }}" method="POST">
                @csrf
                @method('PATCH')
                ...
                <div class="rounded border shadow-sm">
                    ...
                    <div class="p-3 mt-3">
                        ...
                        <div class="mb-3">
                            ...
                            <x-form.select name="type" class="mt-1 w-full" data-controller="choices"
                                ...
                                @foreach (App\Enum\ClientType::cases() as $key => $value)
                                    <option value="{{ $value }}" @selected(old('type', $client->type->value) == $value)>
                                        {{ $value }}
                                    </option>
                                @endforeach
                            </x-form.select>
                        ...
                        <div class="mb-3" data-client-type-target="hideable">
                            ...
                            <x-form.input name="name" class="mt-1 w-full" :value="$client->name" />
                        </div>
                        ...
                        <div class="flex flex-col mb-3 space-y-3 md:flex-row md:space-y-0 md:space-x-3">
                            <div class="w-full md:w-1/2">
                                ...
                                <div class="flex items-start space-x-2">
                                    <div class="w-3/12">
                                        <x-form.select name="phone_country" class="mt-1 w-full" data-controller="choices">
                                            @foreach ($countries as $country)
                                                <option value="{{ $country->code }}" @selected(old('phone_country', $client->phone_country) == $country->code)>
                                                    {{ $country->dial_code }}
                                                </option>
                                            @endforeach
                                        </x-form.select>
                                    ...
                                    <div class="w-full">
                                        <x-form.input name="phone" class="mt-1 w-full" :value="$client->phone" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="w-full md:w-1/2">
                                ...
                                <x-form.input name="email" type="email" class="mt-1 w-full" :value="$client->email" />
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <x-form.select name="currency_id" class="mt-1 w-full" data-controller="choices">
                                @foreach ($currencies as $currency)
                                    <option value="{{ $currency->id }}" @selected(old('currency_id', $client->currency_id) == $currency->id)>{{ $currency->name }}
                                        ({{ $currency->code }})
                                    </option>
                                @endforeach
                            </x-form.select>
                ...
                <div class="mt-8 rounded border shadow-sm">
                    ...
                    <div class="p-3 mt-3">
                        ...
                        <div class="mb-3">
                            ...
                            <x-form.input name="address" class="mt-1 w-full" :value="$client->address" />
                        </div>
                        ...
                        <div class="flex flex-col mb-3 space-y-3 md:flex-row md:space-y-0 md:space-x-3">
                            <div class="w-full md:w-1/2">
                                ...
                                <x-form.input name="city" :value="$client->city" class="mt-1 w-full" />
                            </div>
                            ...
                            <div class="w-full md:w-1/2">
                                ...
                                <x-form.select name="country" class="mt-1 w-full" data-controller="choices">
                                    @foreach ($countries as $country)
                                        <option value="{{ $country->name }}" @selected(old('country', $client->country) == $country->name)>
                                            {{ $country->name }}
                                        </option>
                                    @endforeach
                                </x-form.select>
                ...
                <div class="mt-8 rounded border shadow-sm">
                    ...
                    <div class="p-3 mt-3">
                        ...
                        <div class="mb-3">
                            ...
                            <x-form.input name="website" class="mt-1 w-full" :value="$client->website" />
                        </div>
                        ...
                        <div class="flex flex-col mb-3 space-y-3 md:flex-row md:space-y-0 md:space-x-3">
                            <div class="w-full">
                                ...
                                <x-form.textarea name="notes"
                                    class="mt-1 w-full">{{ old('notes', $client->notes) }}</x-form.textarea>
                            </div>
                        </div>
