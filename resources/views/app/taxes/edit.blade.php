            ...
            <div class="overflow-x-auto -m-1.5">
                <div class="inline-block p-1.5 w-full min-w-full align-middle">
                    <div
                        ...
                        <div class="py-4 px-6">
                            <form action="{{ route('app.taxes.update', $tax) }}" method="POST">
                                @csrf
                                @method('PATCH')

                                <div class="mb-4">
                                    <x-form.label for="name">Name</x-form.label>
                                    <x-form.input name="name" class="mt-1 w-full" :value="$tax->name" />
                                </div>

                                <div class="mb-4">
                                    <x-form.label for="rate">Rate(%)</x-form.label>
                                    <x-form.input name="rate" class="mt-1 w-full" :value="$tax->rate" />
                                </div>
