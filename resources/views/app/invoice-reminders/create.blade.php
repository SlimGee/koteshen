...
@section('content')
    ...
    <div class="md:w-1/2">
        <form action="{{ route('app.invoices.reminder.store', $invoice) }}" method="POST">
            @csrf

            <div class="rounded border shadow-sm">
                <div class="p-4 bg-slate-50">
                    <h4 class="text-sm font-semibold text-slate-700">Send Invoice Reminder</h4>
                </div>
                ...
                <div class="p-3 mt-3">
                    ...
                    <div class="mb-3">
                        ...
                        <x-form.input name="subject" class="mt-1 w-full" :value="'Invoice ' . $invoice->number . ' - Quick Reminder'" />
                    </div>
