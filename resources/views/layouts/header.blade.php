    <div class="flex absolute top-0 left-0 z-40 items-center w-full bg-transparent ud-header">
        <div class="container mx-auto">
            <div class="flex relative justify-between items-center -mx-4">
                ...
                <div class="flex justify-between items-center px-4 w-full">
                    <div>
                        <button id="navbarToggler"
                            class="block absolute right-4 top-1/2 px-3 rounded-lg ring-blue-600 -translate-y-1/2 lg:hidden focus:ring-2 py-[6px]">
