    <footer class="wow fadeInUp relative z-10 bg-[#090E34] pt-20 lg:pt-[100px]" data-wow-delay=".15s">
        <div class="container mx-auto">
            <div class="flex flex-wrap -mx-4">
                <div class="px-4 w-full sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
                    <div class="mb-10 w-full">
                        ...
                        <div class="flex items-center -mx-3">
                            <a href="javascript:void(0)" class="px-3 text-gray-200 hover:text-white">
                ...
                <div class="px-4 w-full md:w-2/3 lg:w-6/12 xl:w-3/12">
                    <div class="mb-10 w-full">
                        <h4 class="mb-9 text-lg font-semibold text-white">Latest blog</h4>
                        <div class="flex flex-col gap-8">
                            <a href="blog-details.html" class="flex items-center group gap-[22px]">
                                <div class="overflow-hidden rounded">
                                    <img src="./assets/images/blog/blog-footer-01.jpg" alt="blog" />
                                </div>
                                <span class="text-base text-gray-200 group-hover:text-white max-w-[180px]">
                            ...
                            <a href="blog-details.html" class="flex items-center group gap-[22px]">
                                ...
                                <span class="text-base text-gray-200 group-hover:text-white max-w-[180px]">
                                    Recognizing the need is the blue-600...
                                </span>
                            </a>
                        </div>
                    </div>
        ...
        <div class="mt-12 border-t border-[#8890A4] border-opacity-40 py-8 lg:mt-[60px]">
            <div class="container mx-auto">
                <div class="flex flex-wrap -mx-4">
                    ...
                    <div class="px-4 w-full md:w-1/3 lg:w-1/2">
